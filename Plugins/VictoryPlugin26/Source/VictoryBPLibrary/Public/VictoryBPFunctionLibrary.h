...
class VICTORYBPLIBRARY_API UVictoryBPFunctionLibrary : public UBlueprintFunctionLibrary
{
	...
	*/
	...
	UFUNCTION(BlueprintPure, Category = "Victory BP Library|File IO")
	static bool GetFilesContainingFilterString(TArray<FString>& Files, FString RootFolderFullPath, FString Ext,FString Filter, bool printDebug);

	UFUNCTION(BlueprintPure, Category = "Victory BP Library|File IO")
    static bool GetFilesNotContainingFilterString(TArray<FString>& Files, FString RootFolderFullPath, FString Ext,FString Filter, bool printDebug);
