...
bool UVictoryBPFunctionLibrary::GetFilesContainingFilterString(TArray<FString>& Files, FString RootFolderFullPath, FString Ext,FString Filter, bool printDebug)
{
	...
	for (int i=0;i < Files.Num();i++)
	{
		...
		auto iteration= &Files[i];

		if(iteration->Contains(Filter))
		{
...
bool UVictoryBPFunctionLibrary::GetFilesNotContainingFilterString(TArray<FString>& Files, FString RootFolderFullPath, FString Ext,FString Filter, bool printDebug)
 {
 	if (RootFolderFullPath.Len() < 1) return false;
